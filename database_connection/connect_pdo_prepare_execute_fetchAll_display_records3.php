...
// create SQL query
$sql = "SELECT Name FROM city WHERE CountryCode = ? AND NAME LIKE ? ORDER BY Name";

// prepare statement
$statement = $conn->prepare($sql);

// execute query
$statement->execute(["USA", "A%"]);
...
<body>
 ...
 <p>Uses a prepared statement to display results as an associative array. Two  parameters are passed using the '?' placeholder.</p>
