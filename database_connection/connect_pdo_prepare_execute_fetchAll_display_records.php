...
// create SQL query
$sql = "SELECT Name FROM world.city WHERE CountryCode = ? ORDER BY Name";
...
<body>
 ...
 <p>Uses a prepared statement to display results as an associative array. The parameter is passed using the '?' placeholder.</p>
