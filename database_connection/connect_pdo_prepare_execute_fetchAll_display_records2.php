...
// create SQL query
$sql = "SELECT Name FROM world.city WHERE CountryCode = :code ORDER BY Name";

// prepare the statement
$statement = $conn->prepare($sql);

//execute the query
$statement->execute([":code" => "USA"]);
...
<body>
 ...
 <p>Uses a prepared statement to display results as an associative array. The parameter is passed using a variable placeholder.</p>
