...
--
-- Host: 127.0.0.1
-- Generation Time: May 23, 2020 at 05:28 AM
...
CREATE TABLE `scholarships` (
  `scholarshp_id` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `scholarships` (`scholarshp_id`, `organization`, `amount`, `semester`, `year`) VALUES
